...
router.get('/', function (req, res) { highlightscontroller.getHighlights(req, res); });
router.post('/', function (req, res) { highlightscontroller.updateHighlights(req, res); });
router.put('/', function (req, res) { highlightscontroller.createHighlights(req, res); });
router.delete('/', function (req, res) { highlightscontroller.deleteHighlights(req, res); });
